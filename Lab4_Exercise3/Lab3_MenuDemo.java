      ...
      do{
         ...
         switch (choice){
            case '1' :
               ...
               System.out.println("\tPrice: RM" + df.format(menu[0].calcPrice(qty)) + "\n");
               break;
            case '2' :
               ...
               System.out.println("\tPrice: RM" + df.format(menu[1].calcPrice(qty)) + "\n");
               break;
            case '3' :
               ...
               System.out.println("\tPrice: RM" + df.format(menu[2].calcPrice(qty)) + "\n");
               break;
            case '4' :
               ...
               System.out.println("\tPrice: RM" + df.format(menu[3].calcPrice(qty)) + "\n");
               break;
            default :
               break;
            }
